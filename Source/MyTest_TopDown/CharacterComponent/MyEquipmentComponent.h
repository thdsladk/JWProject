...
protected:
	...
	*/
	...
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipment")
	//TWeakObjectPtr<AMyEquipment> m_Equipment_Head{};
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipment")
	//TWeakObjectPtr<AMyEquipment> m_Equipment_LeftHand{};
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipment")
	//TWeakObjectPtr<AMyEquipment> m_Equipment_Chest{};
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipment")
	//TWeakObjectPtr<AMyEquipment> m_Equipment_RightHand{};
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipment")
	//TWeakObjectPtr<AMyEquipment> m_Equipment_LeftFoot{};
	//UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Equipment")
	//TWeakObjectPtr<AMyEquipment> m_Equipment_RightFoot{};
